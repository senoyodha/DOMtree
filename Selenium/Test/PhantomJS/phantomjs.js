...
var set = {
    ...
    NS: {
        ...
        pathOut: '../../../HTMLCompare/DOM/NoScript/PhantomJS/',
    ...
    S: {
        ...
        pathOut: '../../../HTMLCompare/DOM/Scripted/PhantomJS/',
...
if (!set[mode].scriptOn)
    ...
    var phantomjs = webdriver.Capabilities.phantomjs();
    if (!set[mode].scriptOn)
        phantomjs.set('phantomjs.page.settings.javascriptEnabled', false);
    var driver = new webdriver.Builder().withCapabilities(phantomjs).build();
    ...
    log += tools.logDouble('DOM extraction. Test file: ' + (limit - start) + '. Browser: PhantomJS. Test mode: ' + set[mode].mode);
