...
function documents (type){
    ...
    this.window = {content: "", load : function (override) {
        //**/
    }};
}
...
var parsing = function (stream) {
    ...
    var nsEl = {html: "http://www.w3.org/1999/xhtml", mathml: "http://www.w3.org/1998/Math/MathML", svg: "http://www.w3.org/2000/svg", xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace", xmlns: "http://www.w3.org/2000/xmlns/"};
    ...
    function adjustForeignAttr(token) {
        ...
        for (var key in token[2])
            if (list.indexOf(key.toLowerCase()) != -1) {
                var value = key.split(":");
                if (value.length > 1)
                    token[2][key] = {prefix: value[0], localName: value[1], namespace: nsEl[value[0]], value: token[2][key]};
                else
                    token[2][key] = {prefix: null, localName: value[0], namespace: nsEl[value[0]], value: token[2][key]};
                break;
            }
    }
